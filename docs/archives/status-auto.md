...
- [agent-runtime.md](agent-runtime.md), [executor-runtime.md](executor-runtime.md), [tools-runtime.md](tools-runtime.md), [triggers-runtime.md](triggers-runtime.md), [utils-runtime.md](utils-runtime.md)
- [golden-workflows.md](golden-workflows.md) (règles et périmètre des goldens)
- [n8n-installation.md](n8n-installation.md) (guide d’installation)
- [codex-plan.md](codex-plan.md) (plan d’exécution)
